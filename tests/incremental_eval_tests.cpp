...
void check_delta(const char* fen, const char* uci_move) {
    ...
    REQUIRE(evaluate(pos) == evaluate(pos, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, &actual));
...
TEST_CASE("evaluate(): incremental_material_psqt is ignored (falls back to a full rescan) "
    ...
    const int with_weights_ignoring_bad_accumulator =
        evaluate(pos, nullptr, nullptr, &weights, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, &wrong_accumulator);
...
TEST_CASE("evaluate(): a correct incremental_material_psqt produces the exact same result as "
    ...
    REQUIRE(evaluate(pos) == evaluate(pos, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, &after));
}
