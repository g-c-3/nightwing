...
**Bugs fixed:** None in existing code — both new modules build on the already-correct board layer. (Two transcription bugs were caught and avoided in an *external source* consulted while transcribing PSQT values — see DECISIONS.md; not a Nightwing bug.)
